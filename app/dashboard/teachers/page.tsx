...
const TeachersPage = () => {
  ...
  return (
    <div className='w-full h-full p-5 flex justify-center items-center flex-col gap-5'>
      ...
      {isPopupOpen && (
        <>
          ...
          <div className='fixed top-0 left-0 w-full h-full flex justify-center items-center z-[4]'>
            <div className='bg-transparent p-5 flex flex-col justify-between items-center rounded-lg w-[500px] h-[600px] relative'>
              <button
      ...
      <div className={`w-full h-[90%] flex flex-wrap gap-5 justify-center items-center ${isPopupOpen ? 'custom-backdrop-filter opacity-25' : ''}`}>
        {
          staffData.map((staff) => {
            return (
              <div key={staff.id} className='w-full h-20 rounded-lg bg-primary-foreground flex justify-between items-center p-5 gap-5'>
                <div className='flex relative'>
                  ...
                  <div className='image rounded-full border-2 border-primary w-12 h-12 overflow-hidden'>
                    <Image className='object-cover w-full h-full' src={staff.image} height={60} width={60} alt={staff.name} />
                  </div>
                </div>
